...
public class ElementCollectionTest extends EntityManagerTest {
    ...
    public void aplicarContato() {
        ...
        cliente.setContatos(Collections.singletonMap("email", "fernando@email.com.br"));
        ...
        Assertions.assertEquals("fernando@email.com.br", clienteVerificacao.getContatos().get("email"));
    }
}
