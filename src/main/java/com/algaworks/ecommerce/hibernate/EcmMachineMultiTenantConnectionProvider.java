...
public class EcmMachineMultiTenantConnectionProvider implements
    ...
    public void start() {
        ...
        configurarTenant("ecommerce_jpa",
                "jdbc:mysql://192.168.42.33/ecommerce_jpa?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC",
                "developer",
                "dev123");

        configurarTenant("ecommerce_multitenancy",
                "jdbc:mysql://192.168.42.33/ecommerce_multitenancy?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC",
                "developer",
                "dev123");
