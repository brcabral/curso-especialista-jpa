...
public class MapsIdTest extends EntityManagerTest {
    ...
    public void inserirNotaFiscal() {
        ...
        Assert.assertNotNull(notaFiscalInserida);
        Assert.assertEquals(pedido.getId(), notaFiscalInserida.getId());
    }
    ...
    public void inserirItemPedido() {
        ...
        ItemPedido itemPedidoInserido = entityManager.find(ItemPedido.class,
                new ItemPedidoId(pedido.getId(), produto.getId()));
        Assert.assertNotNull(itemPedidoInserido);
    }
}
