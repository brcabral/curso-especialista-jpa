...
public class HerancaTest extends EntityManagerTest {
    ...
    public void salvarCliente() {
        ...
        Assert.assertNotNull(clienteInserido.getId());
    }

    @Test
    public void buscarPagamentos() {
        List<Pagamento> pagamentos = entityManager.
                createQuery("select p from Pagamento p").getResultList();
        Assert.assertFalse(pagamentos.isEmpty());
    }

    @Test
    public void incluirPagamentoCartaoPedido() {
        ...
        Assert.assertNotNull(pedidoInserido.getPagamento());
    }
}
